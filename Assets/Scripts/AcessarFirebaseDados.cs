...
public class AcessarFirebaseDados : MonoBehaviour {
    ...
    protected void StartListener()
    {
        FirebaseDatabase.DefaultInstance
          ...
          .ValueChanged += (object sender2, ValueChangedEventArgs e2) => {
              ...
              {
                  print("Erro Data Base");
                  Debug.LogError(e2.DatabaseError.Message);
                  return;
              }
              Debug.Log("Recebido valores de Questions.");
              string title = leaderBoard[0].ToString();
              leaderBoard.Clear();
              leaderBoard.Add(title);
              Debug.Log("Recebido valores de Title."+title);
              print("Valor SnapShot = "+ e2.Snapshot.Children.ToString());
            print("Valor SnapShot Childrem = " + e2.Snapshot.ChildrenCount.ToString());
              ...
              if (e2.Snapshot != null && e2.Snapshot.ChildrenCount > 0)
              {
                  ...
                  {
                    print("Valor Pergunta =" + childSnapshot.Child("Questions").ToString());
                    //print("Valor Pergunta variavel =" + childSnapshot.Child("Questions").Value.ToString());
                      if (childSnapshot.Child("Questions") == null
                    || childSnapshot.Child("Questions").Value == null)
                      {
                        print("Passou Aqui 1");
                      ...
                      else
                      {
                        ...
                        childSnapshot.Child("R1").Value.ToString());
                          leaderBoard.Insert(1, childSnapshot.Child("question").Value.ToString()
                        + "  " + childSnapshot.Child("R1").Value.ToString());
                      }
                  }
              }
              ...
              //string title2 = leaderBoard[1].ToString();
              //Debug.Log("Recebido valores de Title2." + title2);
          };
    }
    ////////
    /// 
